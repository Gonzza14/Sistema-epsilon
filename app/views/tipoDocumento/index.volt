      ...
      <table class="table table-hover" id="dataTable">
          ...
          <tbody>
              ...
              while($row =mysqli_fetch_array($result)){
                ...
                <td>
                  ...
                  ?>
                  <a href="#deleteModal" data-toggle="modal" data-target="" data-categoriaid="<?php echo $row['idTipoDocumento']; ?>"><i class="fas fa-trash-alt"></i></a>
        ...
        <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
          ...
          <div class="modal-content">
              ...
              <div class="modal-body">Seleccione "eliminar" Si realmente desea eliminar este documento.</div>
              <div class="modal-footer">
              <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancelar</button>
              <form method="POST" action="">
                  <a href="tipoDocumento/delete/<?php echo $id; ?>" class="btn btn-primary" >Eliminar</a>
              </form>
              </div>
          </div>
          </div>
