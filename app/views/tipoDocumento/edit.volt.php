<div class="container"> 
  <div class="row">
    <div class="row py-lg-4">
      <div class="col-sm-12">
          <h2>Modificando documento:</h2>
      </div>
    </div>
  </div>                 
  <form action="<?= $this->url->get('tipoDocumento/update') ?>" class="form-horizontal" method="POST">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <select class="extranjeroTipoDoc form-control" name="extranjeroTipoDoc" id="extranjeroTipoDoc" value="" required><?php if ($extranjeroTipoDoc === 0) { ?><option selected='true' value="0">Documento Nacional</option>
              <option value="1">Documento Extranjero</option><?php } else { ?><option selected='true' value="1">Documento Extranjero</option>
              <option value="0">Documento Nacional</option><?php } ?></select>
          </div>
        </div>
        <div class="row">
          <div class="form-group">
