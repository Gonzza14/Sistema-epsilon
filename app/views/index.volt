...
<html lang="en">
  ...
  >
    <div class="wrapper">
      ...
      <nav class="main-header navbar navbar-expand navbar-dark">
        ...
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a href="{{ url('../index/signin') }}" class="nav-link"
              >Iniciar sesion</a
            >
          </li>
          {% endif %} {% if session.has('AUTH') === false%}
          <li class="nav-item">
            <a href="{{ url('../index/signup') }}" class="nav-link"
              >Registrarse</a
            >
          </li>
          {% endif %} {% if session.has('AUTH')%}
          <li class="nav-item">
            <a href="{{ url('../index/logout') }}" class="nav-link"
              >Cerrar sesion</a
            >
          </li>
          {% endif %}
        ...
        <div class="sidebar">
          ...
          <nav class="mt-2">
            ...
            >
              ...
              <li class="nav-item">
                <a href="{{ url('../beneficiario') }}" class="nav-link">
                  <i class="nav-icon fas fa-marker"></i>
                  <p>Beneficiario</p>
                </a>
              </li>
    ...
    <script src="{{
        url('plugins/datatables-buttons/js/dataTables.buttons.min.js')
      }}"></script>
    <script src="{{
        url('plugins/datatables-buttons/js/buttons.bootstrap4.min.js')
      }}"></script>
    <script src="{{ url('plugins/jszip/jszip.min.js') }}"></script>
    <script src="{{ url('plugins/pdfmake/pdfmake.min.js') }}"></script>
    <script src="{{ url('plugins/pdfmake/vfs_fonts.js') }}"></script>
    <script src="{{
        url('plugins/datatables-buttons/js/buttons.html5.min.js')
      }}"></script>
    <script src="{{
        url('plugins/datatables-buttons/js/buttons.print.min.js')
      }}"></script>
    <script src="{{
        url('plugins/datatables-buttons/js/buttons.colVis.min.js')
      }}"></script>

    <!-- PAGE PLUGINS -->
    <!-- jQuery Mapael -->
    <script src="{{
        url('plugins/jquery-mousewheel/jquery.mousewheel.js')
      }}"></script>
    <script src="{{ url('plugins/raphael/raphael.min.js') }}"></script>
    <script src="{{
        url('plugins/jquery-mapael/jquery.mapael.min.js')
      }}"></script>
    <script src="{{
        url('plugins/jquery-mapael/maps/usa_states.min.js')
      }}"></script>
    <!-- ChartJS -->
